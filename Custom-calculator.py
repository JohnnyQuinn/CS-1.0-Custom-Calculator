...
engine_torque = int(input("What is the max engine torque?:\n"))

#performing calculation
horse_power = int((engine_speed * engine_torque)/CONSTANT)

#print result
print(f"This engine's max horsepower output about {horse_power} HP at {engine_speed} RPMs with {engine_torque} lbs of torque")
